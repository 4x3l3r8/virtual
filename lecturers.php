...
<span class="normalFont"><a href="logout.php" class="btn btn-success navbar-right navbar-btn"><strong>Sign Out</strong></a></span>
			...
			<div class = "col-lg-6 well" style="margin-bottom:5%; border:1px solid black; box-shadow: 0 4px 8px 0 black; opacity:0.95;">
				<h2 style="font-size:22px; text-align:center;">Lecturers Coordinating Your Group</h2><hr>
				<table cellpadding="0" cellspacing="0" border="0" class = "table table-bordered" id="example">
				<tr><th>S/N</th><th>Coordinator</th><th>Group Name</th><th width="20%">Message</th></tr>
				<?php
				$no=0;
				...
				if(mysqli_num_rows($qry)>0){
					while($row=mysqli_fetch_array($qry)){
						...
						$sql=mysqli_query($conn, "select * from course where course_code='$group_name'");
						$col=mysqli_fetch_array($sql);
						echo '<tr><td>'.$no.'</td><td>'.ucwords($col['fullname']).'</td><td>'.$group_name.'</td><td><a href="message.php?message='.$col['lecturer_id'].'"><img src="img/email send.ico" width="17%"></a></td></tr>';
					}
				}else{
					echo '<tr><td colspan="4">No Group Found!</td></tr>';
				}
				?>
