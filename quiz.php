...
<span class="normalFont"><a href="logout.php" class="btn btn-success navbar-right navbar-btn"><strong>Sign Out</strong></a></span>
			...
			<div class = "col-lg-6 well" style="margin-bottom:5%; border:1px solid black; box-shadow: 0 4px 8px 0 black; opacity:0.95;">
				<h2 style="font-size:22px; text-align:center;"><img src="img/6486544_orig.gif" width="14%"> </h2><hr>
				<?php
				$qry=mysqli_query($conn, "select * from registered_group where student_id='$ses_id' AND student_username='$ses_username'");
				if(mysqli_num_rows($qry)>0){
					while($row=mysqli_fetch_array($qry)){
						echo '<div class="box" style="border:1px solid silver; border-bottom:3px solid gray; background-color:#efefef;">
		<a href="quizexe.php?quiz='.$row['group_name'].'">
		<h4 style="color:black; text-align:center; padding:7px;">
		<img src="img/Questionnaire_Archery-512.png" width="6%">&nbsp;&nbsp;'.strtoupper($row['group_name'].' Quiz').'</h4> </a>
						</div>';
					}
				}else{
					echo 'No Group Found !';
