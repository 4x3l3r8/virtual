...
<span class="normalFont"><a href="logout.php" class="btn btn-success navbar-right navbar-btn"><strong>Sign Out</strong></a></span>
		...
		<h1 style="text-align:center; margin:-2%; font-size:23px;"><img src="../img/meeting-512.png" width="9%">&nbsp;&nbsp; Group List</h1><br><br>
			<?php
		...
		<a href="chatexe.php?chat='.$row['course_code'].'" style="float:left; font-size:15px; margin-top:-1.5%; padding-top:3px; padding-bottom:3px;" class="btn btn-success">Login</a>
		<a href="chatexe.php?del='.$row['course_code'].'" style="float:right; font-size:15px; margin-top:-1.5%; padding-top:3px; padding-bottom:3px;" class="btn btn-danger">Delete Posts</a>
		&nbsp;&nbsp;'.strtoupper($row['course_code'].' Group').'</h4>
						</div>';
					}
				}else{
					echo 'No Group Found !';
